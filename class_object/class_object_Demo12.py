    ...
    def save_students(self, students):
        with self.data_file.open('w', encoding='utf-8') as f:
            for student in students:
                f.write(
                    f"{student.stu_id},{student.name},{student.score},{student.age},{student.gender},{student.class_name}\n")
...
if __name__ == "__main__":
    ...
    try:
        ...
        for student in students_by_name:
            print(
                f"ID：{student.stu_id}，姓名：{student.name}，成绩：{student.score}，年龄：{student.age}，性别：{student.gender}，班级：{student.class_name}")
